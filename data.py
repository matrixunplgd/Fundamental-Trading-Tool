...
# ─────────────────────────────────────────────────────────────────
FX_RATES = {
    "EUR/USD": {"rate": 1.1712, "chg": 0.15, "hi": 1.1820, "lo": 1.1750, "wchg": 0.6},
    "GBP/USD": {"rate": 1.3493, "chg":  -0.11, "hi": 1.3560, "lo": 1.3480, "wchg":  -0.4},
    "USD/JPY": {"rate": 159.42, "chg":  -0.04, "hi": 159.80, "lo": 158.90, "wchg":  -0.2},
    "USD/CAD": {"rate": 1.3681, "chg":  0.08, "hi": 1.3710, "lo": 1.3620, "wchg":  0.3},
    "AUD/USD": {"rate": 0.7144, "chg":  -0.13, "hi": 0.7150, "lo": 0.7090, "wchg":  -0.5},
    "NZD/USD": {"rate": 0.5874, "chg":  -0.24, "hi": 0.5930, "lo": 0.5870, "wchg":  -0.9},
    "USD/CHF": {"rate": 0.7854, "chg": 0.09, "hi": 0.8040, "lo": 0.7990, "wchg": 0.3},
